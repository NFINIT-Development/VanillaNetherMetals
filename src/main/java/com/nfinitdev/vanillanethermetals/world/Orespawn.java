package com.nfinitdev.vanillanethermetals.world;
...
public class Orespawn implements Function<OreSpawnAPI, SpawnLogic> {
	...
	@Override
	public com.knoxhack.nethermetals.world.SpawnLogic apply(com.knoxhack.nethermetals.world.OreSpawnAPI input) {
